...
public class Util {
    ...
    public static List<String> authPermissionPathsForAll = List.of("auth","ws");
    public static List<String> permissionPathsForAll = List.of("auth", "board/create", "filter-items", "notification", "settings", "ws");
