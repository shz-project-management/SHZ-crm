...
public class UserInBoard {
    ...
    public static UserInBoard adminUserInBoard(User creatorUser, Board board) {
    ...
    public static UserInBoard userInBoardUser(User creatorUser, Board board, Permission permission){
        UserInBoard userInBoard = new UserInBoard();
        userInBoard.setBoard(board);
        userInBoard.setUser(creatorUser);
