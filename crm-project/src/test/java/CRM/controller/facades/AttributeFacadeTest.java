...
public class AttributeFacadeTest {
    ...
    @Test
    @DisplayName("Create status should return Bad Request when status name is illegal")
    ...
    @Test
    @DisplayName("Create status should return Bad Request when status name is not unique")
    ...
    @Test
    @DisplayName("Create status should return Bad Request when attributeRequest has null name")
    public void createStatus_NoName_ServerErrorResponse() {
        ...
        Response response = attributeFacade.create(request, Status.class);
        assertEquals(response.getMessage(), ExceptionMessage.EMPTY_NOTNULL_FIELD.toString());
        assertEquals(HttpStatus.BAD_REQUEST, response.getStatus());
    }

    @Test
    @DisplayName("Create status should return Bad Request when given a non existent board")
    ...
    @Test
    @DisplayName("Create status should return Bad Request when attributeRequest is null")
    public void createStatus_NullAttributeRequest_ServerErrorResponse() {
        Response response = attributeFacade.create(null, Status.class);
        assertEquals(HttpStatus.BAD_REQUEST, response.getStatus());
    }
    ...
    @Test
    @DisplayName("Create type should return Bad Request when type name is illegal")
    ...
    @Test
    @DisplayName("Create type should return Bad Request when type name is not unique")
    ...
    @Test
    @DisplayName("Create type should return Bad Request when attributeRequest has null name")
    ...
    @Test
    @DisplayName("Create type should return Bad Request when given a non existent board")
    ...
    @Test
    @DisplayName("Create type should return Bad Request when attributeRequest is null")
    public void createType_NullAttributeRequest_ServerErrorResponse() {
        Response response = attributeFacade.create(null, Type.class);
        assertEquals(HttpStatus.BAD_REQUEST, response.getStatus());
    }
    ...
    public void createAttribute_NullTypeClass_EmptyData() {
        AttributeRequest request = new AttributeRequest(1L, "Test Attribute", "Test Description");
        Response response = attributeFacade.create(request, null);
